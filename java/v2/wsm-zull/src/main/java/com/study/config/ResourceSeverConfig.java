...
//        resources.resourceId(resourceIds.split(",")[0]).stateless(true);
        resources.resourceId(MyConstant.ResourceAauth);
    ...
    public void configure(HttpSecurity http) throws Exception {
        http.authorizeRequests()
                ...
                .antMatchers("/wsm-oauth/**").permitAll();//可以访问
...
//            List<ResourceRoleInfoDto> dtos = resourceRoleMapper.getResourceRoleInfo(myConfig.getRegionCode());//查当前域下资源角色信息
...
//                        String apiUrl = urlPattern + "/authority_button/" + button;
//                        apiUrls.add(apiUrl);
//                        apiUrlRoleIds.add("");
//                    }
...
//                                int index = apiUrls.indexOf(urlPattern + "/authority_button/" + roleButton);
//                                if (index != -1) {
